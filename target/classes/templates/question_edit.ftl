    ...
    <form class="layui-form" action="">
        <div class="layui-inline">
            ...
            <script type="text/html" id="barDemo">
                ...
                <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="manage">处理</a>
            </script>
...
<script type="text/javascript">
    layui.use(['laydate', 'laypage', 'layer', 'table','form'], function(){
        ...
        table.render({
            ...
            ,height: 495
            ,url: '/questionEdit/selectQuestion'     //数据接口
            ,title: '问题件处理'
            ,page:true           //是否开启分页
            ,totalRow: true
           ,limit:10
            ,cols: [[ //表头
                ...
                ,{field: 'custrank', title: '客户级别'}
                ,{field: 'wentibranch', title: '问题网点'}
                ,{field: 'sender', title: '寄件人姓名'}
                ,{field: 'sendphone', title: '寄件人电话'}
                ,{field: 'itemtype', title: '物品类型'}
                ,{field: 'itemweight', title: '重量(kg)'}
                ,{field: 'exptime', title: '寄件时间'}
                ,{field: 'Expstate', title: '运单状态',templet:function (s) {
                        if(s.Expstate==4){
                            s.Expstate="问题单";
                        }
                        return s.Expstate;
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'manage'){
                layer.open({
                    ...
                    title: ['处理', 'font-size:18px;'],  //弹出框标题
                    shade: [0.5, '#393D49'],     //遮罩层
                    shadeClose:true,          //点击遮罩层外区域关闭遮罩层
                    area: ['780px', '500px'],    //弹出框大小
                    anim: 1,              //弹出动画
                    content:'/questionEdit/selManage?expid='+data.expid,
                    end: function () {
                        location.reload();
                    }
                ...
                layer.open({
                    ...
                    area: ['780px', '500px'],    //弹出框大小
                    anim: 1,              //弹出动画
                    content:'/questionEdit/selQuestion?expid='+data.expid,
                    end: function () {
                        location.reload();
                    }
