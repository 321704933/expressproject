    ...
    <div class="layui-fluid">
        ...
        <form class="layui-form" action="" id="formid">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input id="password1" type="password" name="password" required lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="password" id="password2" required lay-verify="required" placeholder="请确认新密码"
                           autocomplete="off" class="layui-input">
                </div>
