...
public class OfferController {
    ...
    @ResponseBody
    public Object insertOffer(HttpServletRequest request,Offer offer){
        ...
        Integer data = offerService.insertSelete(offer);
        ...
        return data;   //"redirect:/admin/offer/offerselect"
    }
